...
flags.DEFINE_string('validation_directory', '/Users/jh/working_data/imagenet/val',
                           'Validation data directory')
flags.DEFINE_string('output_directory', '/Users/jh/working_data/imagenet/tfrecord',
...
class ImageCoder(object):
  ...
  def png_to_jpeg(self, image_data):
    ...
    buffer = tf.io.decode_png( image_data, channels=3 )

    return tf.io.encode_jpeg( buffer, format='rgb', quality=100 )

  def cmyk_to_rgb(self, image_data):
    # return self._sess.run(self._cmyk_to_rgb,
    #                       feed_dict={self._cmyk_data: image_data})
    buffer = tf.io.decode_jpeg( image_data, channels=0 )
    return tf.io.encode_jpeg( buffer, format='rgb', quality=100 )
